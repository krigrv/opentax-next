...
import { Container, Text, Spacer, Divider } from '@/components/ui';
...
const Footer = () => {
  ...
  const navigation = {
    ...
    social: [
      {
        name: 'GitHub',
        href: 'https://github.com/yourusername/opentax',
        icon: (props: IconProps) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props.props}>
            <path
              fillRule="evenodd"
    ...
    <footer className="bg-[hsl(var(--background))] border-t border-[hsl(var(--border))]">
      <Container className="py-12">
        ...
        <Text className="text-center text-base text-muted-foreground">
          &copy; {currentYear} OpenTax. {t('all_rights_reserved')}.
        </Text>
        <Spacer />
        <div className="flex justify-center space-x-6">
